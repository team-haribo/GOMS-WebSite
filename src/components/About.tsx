...
export default function About() {
  ...
  return (
    <section id="about" className="py-24 sm:py-32 bg-[#FFF8EE]" ref={ref}>
      <div className="max-w-6xl mx-auto px-6">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className={visible ? "animate-fade-in-up" : "opacity-0"}>
            ...
            <h2 className="mt-4 text-3xl sm:text-4xl font-bold text-[#1E1E1E] leading-snug">
              외출제를
              <br />
              <span className="text-[#F5A623]">더 스마트하게</span>
            </h2>
          ...
          <div className={`flex justify-center ${visible ? "animate-fade-in-up delay-200" : "opacity-0"}`}>
            <div className="relative">
              <div className="w-72 h-72 sm:w-80 sm:h-80 rounded-3xl bg-gradient-to-br from-[#F5A623] to-[#FF8C00] p-1 animate-pulse-glow">
                <div className="w-full h-full rounded-3xl bg-white flex flex-col items-center justify-center gap-4">
                  <div className="text-6xl">📱</div>
                  <div className="text-center">
                    <p className="text-2xl font-bold text-[#1E1E1E]">QR</p>
                    <p className="text-[#6B7280] text-sm mt-1">Scan & Go</p>
                  </div>
                </div>
              </div>
